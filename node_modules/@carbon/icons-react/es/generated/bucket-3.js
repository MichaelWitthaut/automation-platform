...
const ChartDualYAxis = /*#__PURE__*/ React.forwardRef(function ChartDualYAxis({ children, size = 16, ...rest }, ref) {
...
const ChartErrorBarAlt = /*#__PURE__*/ React.forwardRef(function ChartErrorBarAlt({ children, size = 16, ...rest }, ref) {
	return React.createElement(Icon, {
		width: size,
		height: size,
		ref,
...
const ChartPerformance = /*#__PURE__*/ React.forwardRef(function ChartPerformance({ children, size = 16, ...rest }, ref) {
	return React.createElement(Icon, {
		width: size,
		height: size,
		ref,
		...
		fill: "currentColor",
		...rest
	}, /* @__PURE__ */ jsx("path", { d: "M28,28v-13h-2v13h-4v-11h-2v11h-4v-9h-2v9h-4v-7h-2v7h-4V2h-2v26c0,1.1.9,2,2,2h26v-2h-2ZM28,4v7h-2v-3.58l-8.29,8.29c-.2.19-.45.29-.71.29s-.51-.1-.71-.29l-4.29-4.3-4.29,4.3-1.42-1.42,5-5c.39-.39,1.03-.39,1.42,0l4.29,4.3,7.58-7.59h-3.58v-2h7Z" }), children);
});
if (process.env.NODE_ENV !== "production") ChartPerformance.propTypes = iconPropTypes;
...
const ClassificationGroups = /*#__PURE__*/ React.forwardRef(function ClassificationGroups({ children, size = 16, ...rest }, ref) {
	return React.createElement(Icon, {
		width: size,
		height: size,
		ref,
		...
		fill: "currentColor",
		...rest
	}, /* @__PURE__ */ jsx("path", { d: "M8,17h5l2,2-2,2h-5v-4ZM30,28V4c0-1.103-.8975-2-2-2h-4v2h4v24h-4v2h4c1.1025,0,2-.8975,2-2ZM8,28h-4V4h4v-2h-4c-1.103,0-2,.897-2,2v24c0,1.1025.897,2,2,2h4v-2ZM24,23v-10c0-.2651-.1055-.5195-.293-.707l-5-5c-.1875-.1875-.4414-.293-.707-.293h-6c-1.103,0-2,.897-2,2v6h2v-6h4v4c0,1.103.897,2,2,2h4v8h-12c0,1.1025.897,2,2,2h10c1.1025,0,2-.8975,2-2ZM21.5859,13h-3.5859v-3.5859l3.5859,3.5859Z" }), children);
});
if (process.env.NODE_ENV !== "production") ClassificationGroups.propTypes = iconPropTypes;
