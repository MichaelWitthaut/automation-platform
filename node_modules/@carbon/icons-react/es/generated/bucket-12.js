...
if (process.env.NODE_ENV !== "production") LocationGroup.propTypes = iconPropTypes;
...
const LocationSupplier = /*#__PURE__*/ React.forwardRef(function LocationSupplier({ children, size = 16, ...rest }, ref) {
	return React.createElement(Icon, {
		width: size,
		height: size,
		ref,
		...
		fill: "currentColor",
		...rest
	}, /* @__PURE__ */ jsx("path", { d: "M14.02,22l-5.02,5-1.41-1.41,2.59-2.59H2v-2h8.18l-2.59-2.59,1.41-1.41,5.02,5ZM28.6699,19.1787c.0391-.0488.2432-.3193.2432-.3193h0c1.1279-1.4844,1.749-3.3315,1.748-5.1987,0-4.7754-3.8857-8.6606-8.6611-8.6606s-8.6606,3.8848-8.6606,8.6582c-.0029,1.8677.626,3.7266,1.7715,5.2344l6.8892,8.1533,6.6699-7.8672ZM16.7031,17.6826c-.8813-1.1611-1.3657-2.5889-1.3638-4.0229,0-3.6724,2.9878-6.6597,6.6606-6.6597s6.6611,2.9878,6.6611,6.6611c.001,1.4336-.4756,2.8501-1.3418,3.9912l-5.3193,6.3018-5.0952-6.0088-.2017-.2627ZM24,12c0-1.1046-.8954-2-2-2s-2,.8954-2,2,.8954,2,2,2,2-.8954,2-2Z" }), children);
});
if (process.env.NODE_ENV !== "production") LocationSupplier.propTypes = iconPropTypes;
...
const LocationSwitch = /*#__PURE__*/ React.forwardRef(function LocationSwitch({ children, size = 16, ...rest }, ref) {
	return React.createElement(Icon, {
		width: size,
		height: size,
		ref,
...
const LogoAstradb = /*#__PURE__*/ React.forwardRef(function LogoAstradb({ children, size = 16, ...rest }, ref) {
	return React.createElement(Icon, {
		width: size,
		height: size,
		ref,
		...
		fill: "currentColor",
		...rest
	}, /* @__PURE__ */ jsx("path", { d: "M20.46,23.88l-2.41,0.79c-0.23,0.08-0.41,0.25-0.49,0.48l-0.82,2.34c-0.24,0.69-1.25,0.69-1.49,0 l-0.82-2.34c-0.08-0.22-0.26-0.4-0.49-0.48l-2.41-0.79c-0.71-0.23-0.71-1.21,0-1.44l2.41-0.79c0.23-0.08,0.41-0.25,0.49-0.48 l0.82-2.33c0.24-0.69,1.25-0.69,1.49,0l0.82,2.33c0.08,0.22,0.26,0.4,0.49,0.48l2.41,0.79C21.17,22.67,21.17,23.65,20.46,23.88z M17.44,4h-3.05c-0.44,0-0.83,0.22-1.05,0.59L2.16,23.24C1.69,24.02,2.28,25,3.21,25h3.06c0.44,0,0.84-0.22,1.05-0.59L18.49,5.76 C18.96,4.98,18.37,4,17.44,4L17.44,4z M29.83,23.23L21.56,9.59c-0.48-0.79-1.67-0.79-2.15,0l0,0l-1.56,2.57 c-0.22,0.37-0.22,0.81,0,1.18l6.71,11.07c0.22,0.37,0.63,0.59,1.07,0.59h3.12c0.95,0,1.55-0.98,1.07-1.77H29.83z" }), children);
});
if (process.env.NODE_ENV !== "production") LogoAstradb.propTypes = iconPropTypes;
...
const LogoMilvus = /*#__PURE__*/ React.forwardRef(function LogoMilvus({ children, size = 16, ...rest }, ref) {
	return React.createElement(Icon, {
		width: size,
		height: size,
		ref,
		...
		fill: "currentColor",
		...rest
	}, /* @__PURE__ */ jsx("path", { d: "M29,13.46c0,8.58-6.95,15.53-15.53,15.53c-0.51,0-0.92-0.41-0.92-0.92s0.41-0.92,0.92-0.92 c7.56,0,13.69-6.13,13.69-13.69c0-0.51,0.41-0.92,0.92-0.92S29,12.95,29,13.46L29,13.46z M11.92,9.88c0.9,0.51,2.05,0.84,3.35,1.2 c1.58,0.44,3.41,0.94,4.81,1.98c1.69,1.24,2.84,2.68,2.44,5.37c0.88-1.44,1.74-3.36,1.57-6.06c-0.35-5.58-5.4-9.8-10.17-9.35 c-1.87,0.18-3.78,1.7-3.61,4.43c0.07,1.18,0.65,1.88,1.6,2.42l0,0L11.92,9.88z M16.8,19.66c-0.07-1.18-0.65-1.88-1.6-2.42 c-0.9-0.51-2.05-0.84-3.35-1.2c-1.58-0.44-3.41-0.94-4.81-1.98C5.35,12.82,4.2,11.38,4.6,8.69c-0.88,1.44-1.74,3.36-1.57,6.06 c0.35,5.58,5.4,9.8,10.17,9.35c1.87-0.18,3.78-1.7,3.61-4.43l0,0L16.8,19.66z" }), children);
});
if (process.env.NODE_ENV !== "production") LogoMilvus.propTypes = iconPropTypes;
...
const LogoOpensearch = /*#__PURE__*/ React.forwardRef(function LogoOpensearch({ children, size = 16, ...rest }, ref) {
	return React.createElement(Icon, {
		width: size,
		height: size,
		ref,
		...
		fill: "currentColor",
		...rest
	}, /* @__PURE__ */ jsx("path", { d: "M24.05,11.63c-0.66-1.35-1.62-2.54-2.8-3.46c-1.84-1.47-3.95-2.13-6.27-2.15 c-0.7,0-1.39,0.08-2.07,0.24c-1.73,0.37-3.34,1.21-4.64,2.43C7.6,9.32,6.96,9.98,6.3,10.63c-1.17,1.17-2.34,2.35-3.51,3.52 c-0.36,0.36-0.72,0.72-1.08,1.08c-0.49,0.48-0.5,1.03-0.01,1.52c0.35,0.36,0.71,0.71,1.07,1.07c0.79,0.79,1.58,1.58,2.37,2.37 c0.92,0.92,1.84,1.85,2.76,2.77c0.36,0.37,0.75,0.71,1.17,1.02c1.76,1.31,3.72,2.01,6.04,2.01c0.86-0.01,1.72-0.13,2.56-0.34 c1.86-0.47,3.54-1.5,4.81-2.95c2-2.24,2.82-4.88,2.51-7.88c-0.12-1.11-0.44-2.19-0.93-3.19l0,0L24.05,11.63z M21.29,20.4 c-1.16,1.51-2.67,2.48-4.54,2.82c-0.15,0.03-0.31,0.05-0.47,0.06c-0.25,0.03-0.49,0.04-0.74,0.04c-2.13,0-3.87-0.73-5.32-2.17 c-0.89-0.88-1.77-1.77-2.65-2.65c-0.66-0.66-1.32-1.32-1.97-1.98c-0.33-0.34-0.32-0.74,0.02-1.07c0.53-0.52,1.05-1.05,1.57-1.57 c1.04-1.04,2.08-2.09,3.14-3.13c1.08-1.07,2.46-1.77,3.96-1.99c1.46-0.23,2.88-0.07,4.22,0.58c1.5,0.72,2.68,1.79,3.45,3.3 c0.43,0.84,0.7,1.76,0.77,2.71c0.14,1.85-0.3,3.56-1.43,5.03l0,0L21.29,20.4z M30.75,15.95c0,0.29-0.1,0.57-0.31,0.77 c-0.92,0.94-1.84,1.87-2.76,2.81c-0.1,0.1-0.2,0.12-0.31,0.07c-0.11-0.06-0.15-0.15-0.12-0.3c0.14-0.67,0.25-1.35,0.31-2.03 c0.05-0.62,0.06-1.24,0.04-1.86c-0.03-0.89-0.14-1.77-0.33-2.64c-0.03-0.09-0.02-0.18,0.02-0.27c0.07-0.11,0.22-0.14,0.33-0.07l0,0 c0.04,0.03,0.07,0.06,0.1,0.09c0.89,0.9,1.78,1.81,2.67,2.71c0.21,0.21,0.35,0.46,0.35,0.71l0,0L30.75,15.95z M20.38,16 c0,2.76-2.18,5.01-4.89,5.02h-0.03c-2.89,0-4.96-2.44-4.92-5.09c0.05-2.77,2.29-4.97,5-4.92c2.68,0.05,4.83,2.27,4.83,5l0,0 L20.38,16z" }), children);
});
if (process.env.NODE_ENV !== "production") LogoOpensearch.propTypes = iconPropTypes;
...
const LogoTwitter = /*#__PURE__*/ React.forwardRef(function LogoTwitter({ children, size = 16, ...rest }, ref) {
	if (process.env.NODE_ENV !== "production") {
		if (!didWarnAboutDeprecation["LogoTwitter"]) {
			didWarnAboutDeprecation["LogoTwitter"] = true;
			console.warn("Icon no longer relevant. Replaced with logo--x.. As a result, the LogoTwitter component will be removed in the next major version of @carbon/icons-react.");
		}
	}
	return React.createElement(Icon, {
		width: size,
