...
const LockedFilled = /*#__PURE__*/ react.default.forwardRef(function LockedFilled({ children, size = 16, ...rest }, ref) {
	return react.default.createElement(require_Icon_js, {
		width: size,
		height: size,
		ref,
...
if (process.env.NODE_ENV !== "production") LockedFilled.propTypes = require_iconPropTypes.iconPropTypes;
...
const LogoAstradb = /*#__PURE__*/ react.default.forwardRef(function LogoAstradb({ children, size = 16, ...rest }, ref) {
	return react.default.createElement(require_Icon_js, {
		width: size,
		height: size,
		ref,
		...
		fill: "currentColor",
		...rest
	}, /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M20.46,23.88l-2.41,0.79c-0.23,0.08-0.41,0.25-0.49,0.48l-0.82,2.34c-0.24,0.69-1.25,0.69-1.49,0 l-0.82-2.34c-0.08-0.22-0.26-0.4-0.49-0.48l-2.41-0.79c-0.71-0.23-0.71-1.21,0-1.44l2.41-0.79c0.23-0.08,0.41-0.25,0.49-0.48 l0.82-2.33c0.24-0.69,1.25-0.69,1.49,0l0.82,2.33c0.08,0.22,0.26,0.4,0.49,0.48l2.41,0.79C21.17,22.67,21.17,23.65,20.46,23.88z M17.44,4h-3.05c-0.44,0-0.83,0.22-1.05,0.59L2.16,23.24C1.69,24.02,2.28,25,3.21,25h3.06c0.44,0,0.84-0.22,1.05-0.59L18.49,5.76 C18.96,4.98,18.37,4,17.44,4L17.44,4z M29.83,23.23L21.56,9.59c-0.48-0.79-1.67-0.79-2.15,0l0,0l-1.56,2.57 c-0.22,0.37-0.22,0.81,0,1.18l6.71,11.07c0.22,0.37,0.63,0.59,1.07,0.59h3.12c0.95,0,1.55-0.98,1.07-1.77H29.83z" }), children);
});
if (process.env.NODE_ENV !== "production") LogoAstradb.propTypes = require_iconPropTypes.iconPropTypes;
...
const LogoMilvus = /*#__PURE__*/ react.default.forwardRef(function LogoMilvus({ children, size = 16, ...rest }, ref) {
	return react.default.createElement(require_Icon_js, {
		width: size,
		height: size,
		ref,
...
const LogoOpensearch = /*#__PURE__*/ react.default.forwardRef(function LogoOpensearch({ children, size = 16, ...rest }, ref) {
	return react.default.createElement(require_Icon_js, {
		width: size,
		height: size,
		ref,
...
exports.LocationSwitch = LocationSwitch;
exports.Locked = Locked;
exports.LockedAndBlocked = LockedAndBlocked;
exports.LockedFilled = LockedFilled;
...
exports.LogoAstradb = LogoAstradb;
