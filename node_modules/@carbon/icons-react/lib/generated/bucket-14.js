...
const OffsetEnvironmental = /*#__PURE__*/ react.default.forwardRef(function OffsetEnvironmental({ children, size = 16, ...rest }, ref) {
	return react.default.createElement(require_Icon_js, {
		width: size,
		height: size,
		ref,
...
const PackageLibrary = /*#__PURE__*/ react.default.forwardRef(function PackageLibrary({ children, size = 16, ...rest }, ref) {
	return react.default.createElement(require_Icon_js, {
		width: size,
		height: size,
		ref,
		...
		fill: "currentColor",
		...rest
	}, /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M28,28H4c-1.103,0-2-.8975-2-2V6c0-1.103.897-2,2-2h10c1.103,0,2,.897,2,2v4h12c1.1025,0,2,.897,2,2v14c0,1.1025-.8975,2-2,2ZM4,12h-.0015l.0015,14h24v-14H4ZM4,10h10v-4H4v4ZM22,21H7v-2h15v2ZM25,17H7v-2h18v2Z" }), children);
});
if (process.env.NODE_ENV !== "production") PackageLibrary.propTypes = require_iconPropTypes.iconPropTypes;
...
const ParameterAction = /*#__PURE__*/ react.default.forwardRef(function ParameterAction({ children, size = 16, ...rest }, ref) {
	return react.default.createElement(require_Icon_js, {
		width: size,
		height: size,
		ref,
		...
		fill: "currentColor",
		...rest
	}, /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M16,29H2v-2h13V5H2v-2h14c.5522,0,1,.4478,1,1v6h9c.5527,0,1,.4478,1,1v10c0,.5527-.4473,1-1,1h-9v6c0,.5527-.4478,1-1,1ZM17,20h8v-8h-8v8Z" }), children);
});
if (process.env.NODE_ENV !== "production") ParameterAction.propTypes = require_iconPropTypes.iconPropTypes;
...
exports.OffsetEnvironmental = OffsetEnvironmental;
exports.Omega = Omega;
...
exports.ParameterAction = ParameterAction;
