...
const ActivityTask = /*#__PURE__*/ react.default.forwardRef(function ActivityTask({ children, size = 16, ...rest }, ref) {
	return react.default.createElement(require_Icon_js, {
		width: size,
		height: size,
		ref,
		...
		fill: "currentColor",
		...rest
	}, /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M28,26H4c-1.1,0-2-.9-2-2V8c0-1.1.9-2,2-2h24c1.1,0,2,.9,2,2v16c0,1.1-.9,2-2,2ZM4,8h0v16h24V8H4Z" }), children);
});
if (process.env.NODE_ENV !== "production") ActivityTask.propTypes = require_iconPropTypes.iconPropTypes;
...
const AiAgent = /*#__PURE__*/ react.default.forwardRef(function AiAgent({ children, size = 16, ...rest }, ref) {
	return react.default.createElement(require_Icon_js, {
		width: size,
		height: size,
		ref,
...
const IbmAiFinancialInstrumentSustainabilityCheck = /*#__PURE__*/ react.default.forwardRef(function IbmAiFinancialInstrumentSustainabilityCheck({ children, size = 16, ...rest }, ref) {
	return react.default.createElement(require_Icon_js, {
		width: size,
		height: size,
		ref,
...
if (process.env.NODE_ENV !== "production") IbmAiFinancialInstrumentSustainabilityCheck.propTypes = require_iconPropTypes.iconPropTypes;
...
exports.AiAgentDetached = AiAgentDetached;
...
exports.IbmAiFinancialInstrumentSustainabilityCheck = IbmAiFinancialInstrumentSustainabilityCheck;
