...
const CloudFoundry_1 = /*#__PURE__*/ react.default.forwardRef(function CloudFoundry_1({ children, size = 16, ...rest }, ref) {
...
const CloudFoundry_2 = /*#__PURE__*/ react.default.forwardRef(function CloudFoundry_2({ children, size = 16, ...rest }, ref) {
	return react.default.createElement(require_Icon_js, {
		width: size,
		height: size,
		ref,
...
const CloudSatelliteLink = /*#__PURE__*/ react.default.forwardRef(function CloudSatelliteLink({ children, size = 16, ...rest }, ref) {
	return react.default.createElement(require_Icon_js, {
		width: size,
		height: size,
		ref,
...
const Connection = /*#__PURE__*/ react.default.forwardRef(function Connection({ children, size = 16, ...rest }, ref) {
	return react.default.createElement(require_Icon_js, {
		width: size,
		height: size,
		ref,
		...
		fill: "currentColor",
		...rest
	}, /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M27,22.13v-12.26c1.72-.44,3-2.01,3-3.87,0-2.21-1.79-4-4-4-1.86,0-3.43,1.28-3.87,3h-12.26c-.44-1.72-2.01-3-3.87-3-2.21,0-4,1.79-4,4,0,1.86,1.28,3.43,3,3.87v12.26c-1.73.44-3,2.01-3,3.87,0,2.21,1.79,4,4,4,1.86,0,3.43-1.27,3.87-3h12.26c.44,1.72,2.01,3,3.87,3,2.21,0,4-1.79,4-4,0-1.86-1.28-3.43-3-3.87ZM26,4c1.1,0,2,.9,2,2s-.9,2-2,2-2-.9-2-2,.9-2,2-2ZM4,6c0-1.1.9-2,2-2s2,.9,2,2-.9,2-2,2-2-.9-2-2ZM22.13,25h-12.26c-.36-1.41-1.46-2.51-2.87-2.87v-12.26c1.4-.36,2.51-1.47,2.87-2.87h12.26c.36,1.4,1.47,2.51,2.87,2.87v12.26c-1.4.36-2.51,1.47-2.87,2.87ZM26,28c-1.1,0-2-.9-2-2s.9-2,2-2,2,.9,2,2-.9,2-2,2Z" }), children);
});
if (process.env.NODE_ENV !== "production") Connection.propTypes = require_iconPropTypes.iconPropTypes;
...
const ConnectionSignalAlt = /*#__PURE__*/ react.default.forwardRef(function ConnectionSignalAlt({ children, size = 16, ...rest }, ref) {
	return react.default.createElement(require_Icon_js, {
		width: size,
		height: size,
		ref,
...
exports.ConnectionSignalAlt = ConnectionSignalAlt;
