...
const StateDefinition = /*#__PURE__*/ react.default.forwardRef(function StateDefinition({ children, size = 16, ...rest }, ref) {
	return react.default.createElement(require_Icon_js, {
		width: size,
		height: size,
		ref,
		...
		fill: "currentColor",
		...rest
	}, /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M28,27H4c-1.103,0-2-.8975-2-2V7c0-1.103.897-2,2-2h24c1.1025,0,2,.897,2,2v18c0,1.1025-.8975,2-2,2ZM4,7h-.0015l.0015,18h24V7H4ZM26,12H6v-2h20v2Z" }), children);
});
if (process.env.NODE_ENV !== "production") StateDefinition.propTypes = require_iconPropTypes.iconPropTypes;
const StateExhibit = /*#__PURE__*/ react.default.forwardRef(function StateExhibit({ children, size = 16, ...rest }, ref) {
	return react.default.createElement(require_Icon_js, {
		width: size,
		height: size,
		ref,
		...
		fill: "currentColor",
		...rest
	}, /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M22,30h-12c-4.4111,0-8-3.5889-8-8v-12C2,5.5889,5.5889,2,10,2h12c4.4111,0,8,3.5889,8,8v12c0,4.4111-3.5889,8-8,8ZM10,4c-3.3086,0-6,2.6914-6,6v12c0,3.3086,2.6914,6,6,6h12c3.3086,0,6-2.6914,6-6v-12c0-3.3086-2.6914-6-6-6h-12ZM24,21h-8c-1.103,0-2-.8076-2-1.7998v-3.1875l-3.9805,3.9902-1.416-1.4121,1.5864-1.5908h-4.1719v-2h4.1719l-1.5913-1.5957,1.416-1.4121,3.9854,3.9951v-3.1875c0-.9922.897-1.7998,2-1.7998h8c1.1025,0,2,.8076,2,1.7998v6.4004c0,.9922-.8975,1.7998-2,1.7998ZM16,18.9834l8,.0166v-6h-8v5.9834ZM23,17h-6v-2h6v2Z" }), children);
});
if (process.env.NODE_ENV !== "production") StateExhibit.propTypes = require_iconPropTypes.iconPropTypes;
...
const TaskUser = /*#__PURE__*/ react.default.forwardRef(function TaskUser({ children, size = 16, ...rest }, ref) {
	return react.default.createElement(require_Icon_js, {
		width: size,
		height: size,
		ref,
...
if (process.env.NODE_ENV !== "production") TaskUser.propTypes = require_iconPropTypes.iconPropTypes;
