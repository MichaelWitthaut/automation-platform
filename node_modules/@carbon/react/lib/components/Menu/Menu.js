...
*/
const spacing = 8;
const Menu = (0, react.forwardRef)(function Menu({ backgroundToken = "layer", border: borderProp = false, children, className, containerRef, label, menuAlignment, onClose, onOpen, open, size = "sm", legacyAutoalign = true, target = require_environment.canUseDOM && document.body, x = 0, y = 0, ...rest }, forwardRef) {
	const prefix = require_usePrefix.usePrefix();
	const border = require_index.useFeatureFlag("enable-v12-release") || borderProp;
