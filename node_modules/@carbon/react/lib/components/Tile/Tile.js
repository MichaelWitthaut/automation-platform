...
const ClickableTile = react.default.forwardRef(({ children, className, clicked = false, decorator, disabled, href, light, onClick = () => {}, onKeyDown = () => {}, renderIcon: Icon, hasRoundedCorners, slug, ...rest }, ref) => {
	...
	const hasElementDecorator = react.default.isValidElement(decorator);
	const clickableTile = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(require_index.default, {
		className: classes,
		href,
	...
	if (hasElementDecorator) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: `${prefix}--clickable-tile__wrapper`,
		children: [clickableTile, /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			className: `${prefix}--tile--inner-decorator`,
			children: decorator
		})]
	});
...
const SelectableTile = react.default.forwardRef(({ children, className, decorator, disabled, id, light, onClick = () => {}, onChange = () => {}, onKeyDown = () => {}, selected = false, tabIndex = 0, title, slug, hasRoundedCorners, ...rest }, ref) => {
	...
	const wrapperClassName = (0, classnames.default)(`${prefix}--selectable-tile__wrapper`, {
		[`${prefix}--selectable-tile__wrapper--slug`]: slug,
		[`${prefix}--selectable-tile__wrapper--decorator`]: decorator
	});
	const decoratorNode = slug ? normalizedDecorator : decorator ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: `${prefix}--tile--inner-decorator`,
		children: normalizedDecorator
	}) : null;
	require_useNoInteractiveChildren.useNoInteractiveChildren(labelRef, "The SelectableTile component `children` prop must have no interactive content");
	const selectableTile = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: classes,
	...
	return decoratorNode ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
