...
const CheckboxGroup = ({ children, className, decorator, helperText, invalid, invalidText, legendId, legendText, readOnly, disabled, warn, warnText, slug, orientation = "vertical", ...rest }) => {
	...
	const legendRef = (0, react.useRef)(null);
	...
	require_useNoInteractiveChildren.useNoInteractiveChildren(legendRef, "The CheckboxGroup component `legendText` prop must have no interactive content");
