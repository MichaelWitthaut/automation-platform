...
const TableHeader = forwardRef((props, ref) => {
	...
	useNoInteractiveChildren(headerLabelRef, "The TableHeader component `children` prop must have no interactive content when `isSortable` is true");
	...
	return /* @__PURE__ */ jsxs("th", {
		id,
		"aria-sort": ariaSort,
		className: cx(headerClassName, `${prefix}--table-sort__header`, {
