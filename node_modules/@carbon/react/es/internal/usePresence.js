...
* LICENSE file in the root directory of this source tree.
*/
const usePresence = (ref, isOpen, exitHoldCount = 0, animationNamePrefix) => {
	...
	useIsomorphicEffect(() => {
		...
		const animations = ref.current.getAnimations({ subtree: true }).filter((animation) => animation instanceof CSSAnimation && animation.animationName.startsWith(resolvedPrefix));
